...
public class soal extends javax.swing.JFrame {
    ...
    private void bProsesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bProsesActionPerformed
        ...
        kalimat.append("    - ").append(listMakan.getModel().getElementAt(indexMakanan).toString()).append("\n");
    
        kalimat.append("Daftar Minuman yang dipilih: \n");
        for (int i = indexMinMinuman; i <= indexMaxMinuman; i++) {
            kalimat.append("    - ").append(listMinum.getModel().getElementAt(i).toString()).append("\n");
        }
    
        kalimat.append("Daftar Olahraga yang dipilih: \n");
        for (int i = indexMinOlahraga; i <= indexMaxOlahraga; i++) {
            kalimat.append("    - ").append(listOlahraga.getModel().getElementAt(i).toString()).append("\n");
        }

        areaHasil.setText(kalimat.toString());
